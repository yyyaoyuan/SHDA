...
if __name__ == "__main__":
    ...
    mu = 0.1 # control mmd % for TCD 1; for TS5 0.1
    ...
    source_path = '../../../Datasets/Datasets_Noises/Noises_DifferentMS_6_100/'
    ...
    io.savemat('LearnedResults_TS5/xl_acc', {'xl_acc': xl_acc})
    io.savemat('LearnedResults_TS5/xu_acc', {'xu_acc': xu_acc})
    io.savemat('LearnedResults_TS5/xs_acc', {'xs_acc': xs_acc})

    io.savemat('LearnedResults_TS5/loss_f_xl', {'loss_f_xl': loss_f_xl})
    io.savemat('LearnedResults_TS5/loss_f_xs', {'loss_f_xs': loss_f_xs})

    io.savemat('LearnedResults_TS5/loss_mmd', {'loss_mmd': loss_mmd})
